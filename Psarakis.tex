...
%\author{Maria Psarakis\\University of Colorado Colorado Springs\\Department of Computer Science\\mpsaraki@uccs.edu}

        %comment out second author John~Doe,~\IEEEmembership{Fellow,~OSA,}
        % comment out third author and~Jane~Doe,~\IEEEmembership{Life~Fellow,~IEEE}% <-this % stops a space
%comment out \thanks{M. Shell was with the Department of Electrical and Computer Engineering, Georgia Institute of Technology, Atlanta, GA, 30332 USA e-mail: (see http://www.michaelshell.org/contact.html).}% <-this % stops a space
% comment out \thanks{J. Doe and J. Doe are with Anonymous University.}% <-this % stops a space
% comment out \thanks{Manuscript received April 19, 2005; revised August 26, 2015.}
...
% The paper headers
%\markboth{Header Placeholder %comment out Journal of \LaTeX\ Class Files,~Vol.~14, %No.~8, August~2015}%
%}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.5]{Images/mpsaraki.jpg}
    %\caption{}
    %\label{fig:my_label}
\end{figure}
...
%\appendices
%\section{Apendix A Title Placeholder}
%Appendix A text placeho.
